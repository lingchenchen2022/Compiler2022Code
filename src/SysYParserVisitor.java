...
public interface SysYParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitPlusMinusExp(SysYParser.PlusMinusExpContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMulDivModExp(SysYParser.MulDivModExpContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFuncExp(SysYParser.FuncExpContext ctx);
	/**
